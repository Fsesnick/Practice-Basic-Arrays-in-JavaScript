...
let minhaListaAleatoria= criarListaAleatoria() ;
console.log(minhaListaAleatoria);
...
*/
 for (let i =0; i< minhaListaAleatoria.length; i++){
  console.log('Item' +i+ ' no array é ' + minhaListaAleatoria[i]);
 }
